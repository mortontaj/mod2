...
fetch(`https://currency-converter5.p.rapidapi.com/currency/convert?format=json&from=${currency1}&to=${currency2}&amount=${ammount}`, {
	method: "GET",
	headers: {
		"x-rapidapi-host": "currency-converter5.p.rapidapi.com",
   ...
   <div>
      <h2>Currency Exchange</h2>
       <form className="exchange" onSubmit={handleSubmitExchange}>
        ...
        <br/>
        <button className="button">Click for Exchange Rate</button>
      </form>
       <ol>
